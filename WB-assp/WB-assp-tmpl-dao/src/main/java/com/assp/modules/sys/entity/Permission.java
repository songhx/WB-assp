...
public class Permission implements Serializable {
	...
	private Integer permissionStatus; // '资源状态;0:可用；1：不可用',
	private Integer permissionDeleteFlag; // '是否删除;0:未删除；1：已删除',
	...
	public Integer getPermissionDeleteFlag() {
		return permissionDeleteFlag;
	}

	public void setPermissionDeleteFlag(Integer permissionDeleteFlag) {
